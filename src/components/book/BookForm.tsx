  ...
  if (sent) {
    return (
      <div className="success" role="status">
        ...
        <p>I'll reply within one business day to lock in a flight window for your listing.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="field">
        ...
        <input id="bk-contact" name="contact" required placeholder="Where I should reply" autoComplete="email" />
      </div>
      <div className="field">
      ...
      <p className="under-cta" style={{ textAlign: 'center', margin: '6px 0 0' }}>Free means free — no card, no contract.</p>
    </form>
  );
}
